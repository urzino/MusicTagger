...
train_set, test_set = train_test_split(annotations['mp3_path'], train_size=t_size, test_size=(1-t_size), random_state=42) 
test_set, val_set = train_test_split(test_set, train_size=0.75, test_size=0.25, random_state=42) 
